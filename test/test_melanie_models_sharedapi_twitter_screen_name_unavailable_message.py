...
from sharedapi_client.models.melanie_models_sharedapi_twitter_screen_name_unavailable_message import (
    MelanieModelsSharedapiTwitterScreenNameUnavailableMessage,  # noqa: E501
)

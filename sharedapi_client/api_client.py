...
import sharedapi_client.models
from sharedapi_client import rest
...
class ApiClient:
    ...
    NATIVE_TYPES_MAPPING = {
        ...
        "object": object,
    }  # TODO remove as only py3 is supported?
    _pool = None
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sharedapi_client.models, klass)
    ...
    def request(self, method, url, query_params=None, headers=None, post_params=None, body=None, _preload_content=True, _request_timeout=None):
        ...
        if method == "GET":
            ...
            msg = "http method must be `GET`, `HEAD`, `OPTIONS`, `POST`, `PATCH`, `PUT` or `DELETE`."

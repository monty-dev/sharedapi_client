...
class MelanieModelsSharedapiTwitterScreenNameURLClass(BaseModel):
    """
    MelanieModelsSharedapiTwitterScreenNameURLClass
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterScreenNameURLClass:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterScreenNameURLClass:
        ...
        _obj = MelanieModelsSharedapiTwitterScreenNameURLClass.parse_obj({
            "urls": obj.get("urls")
        })
        return _obj

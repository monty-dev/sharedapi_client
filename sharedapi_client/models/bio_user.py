...
class BioUser(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BioUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BioUser:
        """Create an instance of BioUser from a dict."""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BioUser.parse_obj(obj)

        return BioUser.parse_obj(
            {
                "id": obj.get("id"),
                ...
                "flags": obj.get("flags"),
                "banner": BannerType.from_dict(obj.get("banner")) if obj.get("banner") is not None else None,

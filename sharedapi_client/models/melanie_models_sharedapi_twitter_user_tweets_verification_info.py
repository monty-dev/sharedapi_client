...
class MelanieModelsSharedapiTwitterUserTweetsVerificationInfo(BaseModel):
    """MelanieModelsSharedapiTwitterUserTweetsVerificationInfo."""

    reason: Optional[MelanieModelsSharedapiTwitterUserTweetsReason] = None
    __properties = ["reason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterUserTweetsVerificationInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterUserTweetsVerificationInfo:

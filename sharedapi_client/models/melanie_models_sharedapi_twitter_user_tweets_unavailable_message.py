...
class MelanieModelsSharedapiTwitterUserTweetsUnavailableMessage(BaseModel):
    """
    MelanieModelsSharedapiTwitterUserTweetsUnavailableMessage
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterUserTweetsUnavailableMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterUserTweetsUnavailableMessage:

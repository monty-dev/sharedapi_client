...
class SearchResult(BaseModel):
    ...
    __properties = ["id", "title", "formats", "thumbnails", "thumbnail", "description", "uploader", "uploader_id", "uploader_url", "channel_id", "channel_url", "duration", "view_count", "average_rating", "age_limit", "webpage_url", "categories", "tags", "playable_in_embed", "is_live", "was_live", "live_status", "release_timestamp", "automatic_captions", "subtitles", "comment_count", "chapters", "like_count", "channel", "channel_follower_count", "upload_date", "availability", "original_url", "webpage_url_basename", "webpage_url_domain", "extractor", "extractor_key", "playlist_count", "playlist", "playlist_id", "playlist_title", "playlist_uploader", "playlist_uploader_id", "n_entries", "playlist_index", "playlist_autonumber", "display_id", "fulltitle", "duration_string", "release_date", "requested_subtitles", "asr", "filesize", "format_id", "format_note", "source_preference", "fps", "audio_channels", "height", "quality", "has_drm", "tbr", "url", "width", "language", "language_preference", "ext", "vcodec", "acodec", "abr", "downloader_options", "container", "protocol", "audio_ext", "video_ext", "format", "resolution", "http_headers"]

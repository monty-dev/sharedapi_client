...
class MelanieModelsSharedapiTwitterScreenNameUnavailableMessageEntity(BaseModel):
    ...
    ref: Optional[MelanieModelsSharedapiTwitterScreenNamePurpleRef] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterScreenNameUnavailableMessageEntity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterScreenNameUnavailableMessageEntity:

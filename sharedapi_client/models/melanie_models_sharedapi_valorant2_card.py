...
class MelanieModelsSharedapiValorant2Card(BaseModel):
    """
    MelanieModelsSharedapiValorant2Card
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiValorant2Card:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiValorant2Card:
        """Create an instance of MelanieModelsSharedapiValorant2Card from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MelanieModelsSharedapiValorant2Card.parse_obj(obj)

        _obj = MelanieModelsSharedapiValorant2Card.parse_obj({
            "small": obj.get("small"),
            "large": obj.get("large"),
            "wide": obj.get("wide"),
            "id": obj.get("id")

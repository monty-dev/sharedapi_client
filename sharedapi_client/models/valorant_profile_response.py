...
class ValorantProfileResponse(BaseModel):
    ...
    card: Optional[MelanieModelsSharedapiValorantCard] = None
    ...
    __properties = ["account_level", "avatar_url", "card", "current_rating", "damage_round_ratio", "deaths", "headshot_percent", "info", "kd_ratio", "kills", "last_update", "lost", "matches_played", "mmr", "name", "peak_rating_act", "peak_rating", "puuid", "region", "tag", "win_percent", "wins"]
    ...
    def from_dict(cls, obj: dict) -> ValorantProfileResponse:
        ...
        _obj = ValorantProfileResponse.parse_obj({
            ...
            "card": MelanieModelsSharedapiValorantCard.from_dict(obj.get("card")) if obj.get("card") is not None else None,
            ...
            "info": UserinfoData.from_dict(obj.get("info")) if obj.get("info") is not None else None,
            "kd_ratio": obj.get("kd_ratio"),
            "kills": obj.get("kills"),
            "last_update": obj.get("last_update"),
            "lost": obj.get("lost"),
            "matches_played": obj.get("matches_played"),
            "mmr": MMRData.from_dict(obj.get("mmr")) if obj.get("mmr") is not None else None,
            "name": obj.get("name"),

...
class ValorantProfileResponse(BaseModel):
    ...
    __properties = ["name", "tag", "puuid", "current_rating", "peak_rating", "peak_rating_act", "avatar_url", "card", "account_level", "kd_ratio", "damage_round_ratio", "headshot_percent", "win_percent", "wins", "lost", "matches_played", "region", "kills", "deaths", "last_update"]

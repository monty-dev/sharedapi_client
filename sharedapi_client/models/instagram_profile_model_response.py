...
class InstagramProfileModelResponse(BaseModel):
    ...
    __properties = ["avatar_filename", "avatar_url", "bio_links", "biography", "external_url", "followed_by_count", "following_count", "full_name", "has_channel", "has_clips", "highlight_reel_count", "id", "is_business_account", "is_joined_recently", "is_private", "is_professional_account", "is_verified", "post_count", "pronouns", "username", "post_items", "created_at"]

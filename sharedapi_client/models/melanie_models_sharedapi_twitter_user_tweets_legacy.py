...
class MelanieModelsSharedapiTwitterUserTweetsLegacy(BaseModel):
    """
    ...
    entities: Optional[MelanieModelsSharedapiTwitterUserTweetsEntities] = None
    ...
    __properties = ["protected", "can_dm", "can_media_tag", "created_at", "default_profile", "default_profile_image", "description", "entities", "fast_followers_count", "favourites_count", "followers_count", "friends_count", "has_custom_timelines", "is_translator", "listed_count", "location", "media_count", "name", "normal_followers_count", "pinned_tweet_ids_str", "possibly_sensitive", "profile_image_url_https", "profile_interstitial_type", "screen_name", "statuses_count", "translator_type", "verified", "want_retweets", "withheld_in_countries", "profile_banner_url", "url", "verified_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterUserTweetsLegacy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterUserTweetsLegacy:
        """Create an instance of MelanieModelsSharedapiTwitterUserTweetsLegacy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MelanieModelsSharedapiTwitterUserTweetsLegacy.parse_obj(obj)

        _obj = MelanieModelsSharedapiTwitterUserTweetsLegacy.parse_obj({
            ...
            "entities": MelanieModelsSharedapiTwitterUserTweetsEntities.from_dict(obj.get("entities")) if obj.get("entities") is not None else None,

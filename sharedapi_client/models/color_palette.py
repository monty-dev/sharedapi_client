...
class ColorPalette(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ColorPalette:
    ...
    def to_dict(self):
        ...
        if self.colors is None and "colors" in self.__fields_set__:
            _dict['colors'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ColorPalette:

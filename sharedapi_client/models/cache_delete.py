...
class CacheDelete(BaseModel):
    ...
    CacheDelete
    """
    redis: Optional[Any] = Field(...)
    disk: Optional[Any] = Field(...)
    __properties = ["redis", "disk"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CacheDelete:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if redis (nullable) is None
        # and __fields_set__ contains the field
        if self.redis is None and "redis" in self.__fields_set__:
            _dict['redis'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CacheDelete:

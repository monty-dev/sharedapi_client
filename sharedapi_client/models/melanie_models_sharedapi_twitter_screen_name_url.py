...
class MelanieModelsSharedapiTwitterScreenNameURL(BaseModel):
    """MelanieModelsSharedapiTwitterScreenNameURL."""
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterScreenNameURL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterScreenNameURL:
        """Create an instance of MelanieModelsSharedapiTwitterScreenNameURL from a dict."""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MelanieModelsSharedapiTwitterScreenNameURL.parse_obj(obj)

        return MelanieModelsSharedapiTwitterScreenNameURL.parse_obj(
            {"display_url": obj.get("display_url"), "expanded_url": obj.get("expanded_url"), "url": obj.get("url"), "indices": obj.get("indices")},
        )

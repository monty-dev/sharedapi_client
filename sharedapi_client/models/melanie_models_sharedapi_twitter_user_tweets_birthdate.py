...
class MelanieModelsSharedapiTwitterUserTweetsBirthdate(BaseModel):
    """MelanieModelsSharedapiTwitterUserTweetsBirthdate."""
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MelanieModelsSharedapiTwitterUserTweetsBirthdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MelanieModelsSharedapiTwitterUserTweetsBirthdate:
        """Create an instance of MelanieModelsSharedapiTwitterUserTweetsBirthdate from a dict."""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MelanieModelsSharedapiTwitterUserTweetsBirthdate.parse_obj(obj)

        return MelanieModelsSharedapiTwitterUserTweetsBirthdate.parse_obj(

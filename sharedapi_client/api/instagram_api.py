...
class InstagramApi:
    ...
    def download_instagram_post(
        ...
        **kwargs,
    ) -> InstagramPostResponse:  # noqa: E501
        ...
    ...
    def download_instagram_post(
        ...
        **kwargs,
    ) -> Union[InstagramPostResponse, Awaitable[InstagramPostResponse]]:  # noqa: E501
    ...
    def download_instagram_post_with_http_info(self, instagram_post_request: InstagramPostRequest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        _response_types_map = {"200": "InstagramPostResponse", "422": "HTTPValidationError"}
    ...
    async def fetch_stories(
        self,
        username: Any,
        force: Annotated[Optional[Any], Field(description="Bypass cache and fetch the latest user stories")] = None,
        **kwargs,
    ) -> InstagramStoryResponse:  # noqa: E501
        ...
    ...
    def fetch_stories(
        ...
        async_req: Optional[bool] = None,
        **kwargs,
    ) -> Union[InstagramStoryResponse, Awaitable[InstagramStoryResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def fetch_stories_with_http_info(
        self,
        username: Any,
        force: Annotated[Optional[Any], Field(description="Bypass cache and fetch the latest user stories")] = None,
        **kwargs,
        ...
        _response_types_map = {"200": "InstagramStoryResponse", "422": "HTTPValidationError"}

        return self.api_client.call_api(
            "/api/instagram/story/{username}",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    @overload
    def get_highlightby_id(
        self,
        highlight_id: Any,
        force: Optional[Any] = None,
        async_req: Optional[bool] = True,
        **kwargs,
    ) -> InstagramHighlightResponse:  # noqa: E501
        ...
    ...
    def get_highlightby_id(
        ...
        async_req: Optional[bool] = None,
        **kwargs,
    ) -> Union[InstagramHighlightResponse, Awaitable[InstagramHighlightResponse]]:  # noqa: E501
    ...
    def get_highlightby_id_with_http_info(self, highlight_id: Any, force: Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        _response_types_map = {"200": "InstagramHighlightResponse", "422": "HTTPValidationError"}

        return self.api_client.call_api(
            "/api/instagram/highlight/{highlight_id}",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_highlights(
        ...
        async_req: Optional[bool] = None,
        **kwargs,
    ) -> Union[InstagramHighlightIndexResponse, Awaitable[InstagramHighlightIndexResponse]]:  # noqa: E501
    ...
    def get_highlights_with_http_info(self, username: Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        _response_types_map = {"200": "InstagramHighlightIndexResponse", "422": "HTTPValidationError"}

        return self.api_client.call_api(
            "/api/instagram/highlights/{username}",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    async def get_instagram_user(
        self,
        username: Any,
        force: Annotated[Optional[Any], Field(description="Force refresh or use cached result")] = None,
        preload_posts: Annotated[Optional[Any], Field(description="Whether posts should be preemptively loaded into cache on user fetch")] = None,
        **kwargs,
    ...
    @validate_arguments
    def get_instagram_user_with_http_info(
        self,
        username: Any,
        force: Annotated[Optional[Any], Field(description="Force refresh or use cached result")] = None,
        preload_posts: Annotated[Optional[Any], Field(description="Whether posts should be preemptively loaded into cache on user fetch")] = None,
        **kwargs,
        ...
        _response_types_map = {"200": "InstagramProfileModelResponse", "422": "HTTPValidationError"}

...
class SpeechApi:
    ...
    @overload
    async def perform_speechto_text(self, url : Annotated[Any, Field(..., description="URL of the audio or video file.")], translate : Annotated[Optional[Any], Field(description="Perform the operation with smart translation")] = None, source_langs : Optional[Any] = None, target_lang : Optional[Any] = None, **kwargs) -> STTResult:  # noqa: E501
        ...

    @overload
    def perform_speechto_text(self, url : Annotated[Any, Field(..., description="URL of the audio or video file.")], translate : Annotated[Optional[Any], Field(description="Perform the operation with smart translation")] = None, source_langs : Optional[Any] = None, target_lang : Optional[Any] = None, async_req: Optional[bool]=True, **kwargs) -> STTResult:  # noqa: E501
        ...

    @validate_arguments
    def perform_speechto_text(self, url : Annotated[Any, Field(..., description="URL of the audio or video file.")], translate : Annotated[Optional[Any], Field(description="Perform the operation with smart translation")] = None, source_langs : Optional[Any] = None, target_lang : Optional[Any] = None, async_req: Optional[bool]=None, **kwargs) -> Union[STTResult, Awaitable[STTResult]]:  # noqa: E501
    ...
    @validate_arguments
    def perform_speechto_text_with_http_info(self, url : Annotated[Any, Field(..., description="URL of the audio or video file.")], translate : Annotated[Optional[Any], Field(description="Perform the operation with smart translation")] = None, source_langs : Optional[Any] = None, target_lang : Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Perform Speech To Text  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method perform_speechto_text" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @overload
    def perform_textto_speech(self, tts_translation_request : TTSTranslationRequest, user_id : Optional[Any] = None, async_req: Optional[bool]=True, **kwargs) -> TTSResult:  # noqa: E501
        ...

    @validate_arguments
    def perform_textto_speech(self, tts_translation_request : TTSTranslationRequest, user_id : Optional[Any] = None, async_req: Optional[bool]=None, **kwargs) -> Union[TTSResult, Awaitable[TTSResult]]:  # noqa: E501
    ...
    @validate_arguments
    def perform_textto_speech_with_http_info(self, tts_translation_request : TTSTranslationRequest, user_id : Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Perform Text To Speech  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method perform_textto_speech" % _key
                )
            _params[_key] = _val
        del _params['kwargs']

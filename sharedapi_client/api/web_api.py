...
class WebApi:
    ...
    @validate_arguments
    def get_cashappprofile(self, username : Any, async_req: Optional[bool]=None, **kwargs) -> Union[CashappProfileResponse, Awaitable[CashappProfileResponse]]:  # noqa: E501
    ...
    def get_cashappprofile_with_http_info(self, username : Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_cashappprofile" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CashappProfileResponse",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/cashapp/{username}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_telegram_u_ser(self, username : Any, async_req: Optional[bool]=None, **kwargs) -> Union[TelegramProfileResponse, Awaitable[TelegramProfileResponse]]:  # noqa: E501
    ...
    def get_telegram_u_ser_with_http_info(self, username : Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_telegram_u_ser" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TelegramProfileResponse",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/web/telegram/{username}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def i_plookup(self, address : Annotated[Any, Field(..., description="Full IP address or range to query info on")], **kwargs) -> IPLookupResultResponse:  # noqa: E501
        ...

    @overload
    def i_plookup(self, address : Annotated[Any, Field(..., description="Full IP address or range to query info on")], async_req: Optional[bool]=True, **kwargs) -> IPLookupResultResponse:  # noqa: E501
        ...

    @validate_arguments
    def i_plookup(self, address : Annotated[Any, Field(..., description="Full IP address or range to query info on")], async_req: Optional[bool]=None, **kwargs) -> Union[IPLookupResultResponse, Awaitable[IPLookupResultResponse]]:  # noqa: E501
        """Ip Lookup  # noqa: E501
    ...
    @validate_arguments
    def i_plookup_with_http_info(self, address : Annotated[Any, Field(..., description="Full IP address or range to query info on")], **kwargs) -> ApiResponse:  # noqa: E501
        """Ip Lookup  # noqa: E501
        ...
        _response_types_map = {
            '200': "IPLookupResultResponse",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/web/ip/{address}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def loada_spotifyplaylist(self, playlist_id : Any, plain : Optional[Any] = None, transform : Optional[Any] = None, name : Optional[Any] = None, clean : Optional[Any] = None, **kwargs) -> object:  # noqa: E501
        ...

    @overload
    def loada_spotifyplaylist(self, playlist_id : Any, plain : Optional[Any] = None, transform : Optional[Any] = None, name : Optional[Any] = None, clean : Optional[Any] = None, async_req: Optional[bool]=True, **kwargs) -> object:  # noqa: E501
        ...

    @validate_arguments
    def loada_spotifyplaylist(self, playlist_id : Any, plain : Optional[Any] = None, transform : Optional[Any] = None, name : Optional[Any] = None, clean : Optional[Any] = None, async_req: Optional[bool]=None, **kwargs) -> Union[object, Awaitable[object]]:  # noqa: E501
    ...
    @validate_arguments
    def loada_spotifyplaylist_with_http_info(self, playlist_id : Any, plain : Optional[Any] = None, transform : Optional[Any] = None, name : Optional[Any] = None, clean : Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Load A Spotify Playlist  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method loada_spotifyplaylist" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/spotify/playlist/{playlist_id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def screenshotweb(self, url : Annotated[Any, Field(..., description="URL to screnshot")], user_id : Annotated[Optional[Any], Field(description="User ID requesting the screenshot.")] = None, safe : Annotated[Optional[Any], Field(description="Check the URL's domain against porn malware lists.")] = None, until : Annotated[Optional[Any], Field(description="puppeteer wait method.")] = None, nsfw_check : Annotated[Optional[Any], Field(description="Run the image result through AI content moderation  ")] = None, full_page : Annotated[Optional[Any], Field(description="Waits for page to load, scrolls to bottom")] = None, image_type : Annotated[Optional[Any], Field(description="png or jpeg")] = None, imgerr : Annotated[Optional[Any], Field(description="OK to return an image on failure or send HTTP error code")] = None, **kwargs) -> object:  # noqa: E501
        ...

    @overload
    def screenshotweb(self, url : Annotated[Any, Field(..., description="URL to screnshot")], user_id : Annotated[Optional[Any], Field(description="User ID requesting the screenshot.")] = None, safe : Annotated[Optional[Any], Field(description="Check the URL's domain against porn malware lists.")] = None, until : Annotated[Optional[Any], Field(description="puppeteer wait method.")] = None, nsfw_check : Annotated[Optional[Any], Field(description="Run the image result through AI content moderation  ")] = None, full_page : Annotated[Optional[Any], Field(description="Waits for page to load, scrolls to bottom")] = None, image_type : Annotated[Optional[Any], Field(description="png or jpeg")] = None, imgerr : Annotated[Optional[Any], Field(description="OK to return an image on failure or send HTTP error code")] = None, async_req: Optional[bool]=True, **kwargs) -> object:  # noqa: E501
        ...

    @validate_arguments
    def screenshotweb(self, url : Annotated[Any, Field(..., description="URL to screnshot")], user_id : Annotated[Optional[Any], Field(description="User ID requesting the screenshot.")] = None, safe : Annotated[Optional[Any], Field(description="Check the URL's domain against porn malware lists.")] = None, until : Annotated[Optional[Any], Field(description="puppeteer wait method.")] = None, nsfw_check : Annotated[Optional[Any], Field(description="Run the image result through AI content moderation  ")] = None, full_page : Annotated[Optional[Any], Field(description="Waits for page to load, scrolls to bottom")] = None, image_type : Annotated[Optional[Any], Field(description="png or jpeg")] = None, imgerr : Annotated[Optional[Any], Field(description="OK to return an image on failure or send HTTP error code")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[object, Awaitable[object]]:  # noqa: E501
    ...
    @validate_arguments
    def screenshotweb_with_http_info(self, url : Annotated[Any, Field(..., description="URL to screnshot")], user_id : Annotated[Optional[Any], Field(description="User ID requesting the screenshot.")] = None, safe : Annotated[Optional[Any], Field(description="Check the URL's domain against porn malware lists.")] = None, until : Annotated[Optional[Any], Field(description="puppeteer wait method.")] = None, nsfw_check : Annotated[Optional[Any], Field(description="Run the image result through AI content moderation  ")] = None, full_page : Annotated[Optional[Any], Field(description="Waits for page to load, scrolls to bottom")] = None, image_type : Annotated[Optional[Any], Field(description="png or jpeg")] = None, imgerr : Annotated[Optional[Any], Field(description="OK to return an image on failure or send HTTP error code")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Screenshot Web  # noqa: E501

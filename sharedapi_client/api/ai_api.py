...
class AiApi:
    ...
    @overload
    async def createartwithdalle2(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @overload
    def createartwithdalle2(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=True, **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @validate_arguments
    def createartwithdalle2(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=None, **kwargs) -> Union[AIImageGenerationResponse, Awaitable[AIImageGenerationResponse]]:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method createartwithdalle2" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @overload
    async def createcyberpunkavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @overload
    def createcyberpunkavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=True, **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @validate_arguments
    def createcyberpunkavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=None, **kwargs) -> Union[AIImageGenerationResponse, Awaitable[AIImageGenerationResponse]]:  # noqa: E501
    ...
    def createcyberpunkavatar_with_http_info(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method createcyberpunkavatar" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @overload
    async def createfantasyartavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @overload
    def createfantasyartavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=True, **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @validate_arguments
    def createfantasyartavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=None, **kwargs) -> Union[AIImageGenerationResponse, Awaitable[AIImageGenerationResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def createfantasyartavatar_with_http_info(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create Fantasy Art Avatar  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method createfantasyartavatar" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @overload
    async def createpixelavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @overload
    def createpixelavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=True, **kwargs) -> AIImageGenerationResponse:  # noqa: E501
        ...

    @validate_arguments
    def createpixelavatar(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], async_req: Optional[bool]=None, **kwargs) -> Union[AIImageGenerationResponse, Awaitable[AIImageGenerationResponse]]:  # noqa: E501
    ...
    def createpixelavatar_with_http_info(self, idea : Annotated[Any, Field(..., description="AI generation prompt")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method createpixelavatar" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def evaluate_image_safety(self, url : Any, async_req: Optional[bool]=None, **kwargs) -> Union[ImageEvaluationResult, Awaitable[ImageEvaluationResult]]:  # noqa: E501
    ...
    def evaluate_image_safety_with_http_info(self, url : Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method evaluate_image_safety" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ImageEvaluationResult",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/ai/nsfw_check', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def read_textfrom_image(self, ocr_rquest : OCRRquest, async_req: Optional[bool]=None, **kwargs) -> Union[OCRReadResponse, Awaitable[OCRReadResponse]]:  # noqa: E501
    ...
    def read_textfrom_image_with_http_info(self, ocr_rquest : OCRRquest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_textfrom_image" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def removebackgroundsfromimage_with_http_info(self, url : Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method removebackgroundsfromimage" % _key
                )
            _params[_key] = _val
        del _params['kwargs']

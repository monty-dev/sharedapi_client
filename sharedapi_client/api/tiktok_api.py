...
class TiktokApi:
    ...
    @overload
    def download_tik_tok_post(self, tiktok_post_request : TiktokPostRequest, user_id : Optional[Any] = None, async_req: Optional[bool]=True, **kwargs) -> TikTokVideoResponse:  # noqa: E501
        ...

    @validate_arguments
    def download_tik_tok_post(self, tiktok_post_request : TiktokPostRequest, user_id : Optional[Any] = None, async_req: Optional[bool]=None, **kwargs) -> Union[TikTokVideoResponse, Awaitable[TikTokVideoResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def download_tik_tok_post_with_http_info(self, tiktok_post_request : TiktokPostRequest, user_id : Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Download Tiktok Post  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method download_tik_tok_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TikTokVideoResponse",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/tiktok/post', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    def fetch_user_top_tik_toks(self, username : Any, limit : Optional[Any] = None, async_req: Optional[bool]=True, **kwargs) -> TiktokTopUserVideoResults:  # noqa: E501
        ...

    @validate_arguments
    def fetch_user_top_tik_toks(self, username : Any, limit : Optional[Any] = None, async_req: Optional[bool]=None, **kwargs) -> Union[TiktokTopUserVideoResults, Awaitable[TiktokTopUserVideoResults]]:  # noqa: E501
    ...
    def fetch_user_top_tik_toks_with_http_info(self, username : Any, limit : Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method fetch_user_top_tik_toks" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TiktokTopUserVideoResults",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/tiktok/{username}/top', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_tik_tok_user(self, username : Any, async_req: Optional[bool]=None, **kwargs) -> Union[TikTokUserProfileResponse, Awaitable[TikTokUserProfileResponse]]:  # noqa: E501
    ...
    def get_tik_tok_user_with_http_info(self, username : Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tik_tok_user" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TikTokUserProfileResponse",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/api/tiktok/{username}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def getrecentuser_tik_toks(self, username : Any, async_req: Optional[bool]=None, **kwargs) -> Union[TiktokTopUserVideoResults, Awaitable[TiktokTopUserVideoResults]]:  # noqa: E501
    ...
    def getrecentuser_tik_toks_with_http_info(self, username : Any, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method getrecentuser_tik_toks" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/tiktok/{username}/recent', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
